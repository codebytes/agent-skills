# Talk Guide: Agent Skills, Plugins & Marketplace

Compatibility, demo rehearsal, authoring, and reference notes for the talk.
For the HTML slides, PDF download, and presenter contact, see the
[talk overview](../README.md).
